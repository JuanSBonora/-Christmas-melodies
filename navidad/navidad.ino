...
// Melodias navideñas con Arduino Uno 14/12/2019

#include "pt.h"
#include "timer.h"

// La variable actual realiza un seguimiento de la canción que se reproducirá.
// Actualmente, como hay 4 pistas en el repertorio, el rango de la variable actual es de 0 a 3.
...
static PT_THREAD(protothreadControllerController(struct pt *pt)) {
  ...
  while (1) {
    ...
    //Restablecer los tiempos en los protothreads de música
    PT_INIT(&ptJoyToTheWorld);  
    PT_INIT(&ptWeWishYouAMerry);
    PT_INIT(&ptRudolfTheRedNosed);
    PT_INIT(&ptJingleBells);
